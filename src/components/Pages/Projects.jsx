  ...
  return (
    ...
    <div className="px-4 sm:px-8 md:px-16 lg:px-32">
      <div className="h-8 px-4 bg-slate-300 rounded-b flex justify-start items-center space-x-2 sm:space-x-5">
        ...
        <IoIosArrowForward />
        <span className="cursor-pointer hover:underline text-sm sm:text-md">projects</span>
      </div>
    </div>
    ...
    <div className="bg-white px-4 space-y-3 py-2 rounded-lg shadow-lg w-full max-w-6xl transform transition-all duration-500 overflow-hidden">
          ...
          <h1 className=' text-sm    md:text-2xl'><span className='text-blue-500 font-bold'>Our</span><span className='text-orange-400 font-bold'>Project</span></h1>
